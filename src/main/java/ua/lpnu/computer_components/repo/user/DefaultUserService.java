...
//        new SecurityConfig(passwordEncoder,this).getInMemoryUserDetailsManager();
    ...
    private String buildEmail(String name, String pass) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hello, " + name + ".</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">You have just sent a request about recovering your password.</p>"+
